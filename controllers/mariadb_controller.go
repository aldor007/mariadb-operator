...
//+kubebuilder:rbac:groups=server.mariadb.org,resources=mariadbs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=server.mariadb.org,resources=mariadbs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=server.mariadb.org,resources=mariadbs/finalizers,verbs=update
